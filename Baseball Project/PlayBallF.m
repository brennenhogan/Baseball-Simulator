...
if RunGame==1
    ...
    for i=1:1:NumGames
        ...
        while Inning<=9 || ScoreHome==ScoreAway %While the game is below nine innings or the score is not tied...
            ...
            while Outs<3 %While the outs are below 3, run the inning logic
                ...
                [HittingOutcome,HittingResult]=HittingFunctionTEST(BattingAverage,PitchersOBA, WalkPercentage, SluggingPercentage);
    ...
    handles.HomeWinsT.String=num2str(HomeWins);
    handles.AwayWinsT.String=num2str(AwayWins);
end