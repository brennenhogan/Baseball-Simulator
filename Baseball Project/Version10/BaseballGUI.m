...
% Last Modified by GUIDE v2.5 13-Apr-2018 18:23:41
...
handles.TeamDropdownH.String={'Astros','Athletics','Mariners'};
handles.TeamDropdownA.String={'Astros','Athletics','Mariners'};
populateDD(handles);
