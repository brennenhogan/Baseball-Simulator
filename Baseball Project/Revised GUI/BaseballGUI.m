...
% Last Modified by GUIDE v2.5 10-Apr-2018 14:04:16
...
% --- Executes on selection change in ThridDropdownH.
function ThridDropdownH_Callback(hObject, eventdata, handles)
% hObject    handle to ThridDropdownH (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns ThridDropdownH contents as cell array
%        contents{get(hObject,'Value')} returns selected item from ThridDropdownH


% --- Executes during object creation, after setting all properties.
function ThridDropdownH_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ThridDropdownH (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in ThridDropdownA.
function ThridDropdownA_Callback(hObject, eventdata, handles)
% hObject    handle to ThridDropdownA (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns ThridDropdownA contents as cell array
%        contents{get(hObject,'Value')} returns selected item from ThridDropdownA


% --- Executes during object creation, after setting all properties.
function ThridDropdownA_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ThridDropdownA (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function GameCounter_Callback(hObject, eventdata, handles)
% hObject    handle to GameCounter (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of GameCounter as text
%        str2double(get(hObject,'String')) returns contents of GameCounter as a double


% --- Executes during object creation, after setting all properties.
function GameCounter_CreateFcn(hObject, eventdata, handles)
% hObject    handle to GameCounter (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
